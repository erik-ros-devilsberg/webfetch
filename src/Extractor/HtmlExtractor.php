...
/**
 * Turns a fetched HTML page into readable content. Primary path is
 ...
 *
 * This is the `text/html` implementation of {@see Extractor}; the
 * DispatchingExtractor selects it by content type.
 */
